...
function CustomizedRadios(props) {
    ...
    return (
        <RadioGroup defaultValue="obtain an IP address automatically (DHCP/BootP)" aria-label="gender"
            ...
            <FormControlLabel value="use the following IP address" control={<StyledRadio/>}
...
function CustomizedCheckBoxWithSelect(props) {
    ...
    return (
        <>
            <StyledCheckbox isWifiEnable={props.isWifiEnable} onChange={()=>props.toggleWifiEnable(!props.isWifiEnable)} checked={props.isWifiEnable} name={'Enable wifi:'}/>
...
function CustomizedCheckBoxWithInput(props) {
    ...
    return (
        <>
            <StyledCheckbox onChange={handleChange} checked={isChecked} name={'Enable Wireless Security:'}/>
            <FormControl variant="outlined" className={classes.formControl}>
                <div className={classes.textFieldGroup}>
                    <div className={classes.textField}>
            ...
            <Grid container spacing={0}>
                <Grid className={classes.fieldset} item xs={6}>
                    <FormControl>
                        ...
                        <FormGroup>
                            <CustomizedRadios data={ipData}/>
                            <CustomizedRadios data={dnsData}/>
                        </FormGroup>
                    </FormControl>
                </Grid>
